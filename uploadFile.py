def upload(originalPath):
    ...
    lexiconFile = open("lex.json")
    forwardIndexFile = open("forIndex.json")
    reverseIndexFile = open("revIndex.json")
    metaDataFile = open("metaInfo.json")
    lexiconedFile = open("file1.json")
    ...
    if filename not in parsedFiles:
        ...
        lexiconFile = open("lex.json", "w+")
        forwardIndexFile = open("forIndex.json", "w+")
        reverseIndexFile = open("revIndex.json", "w+")
        metaDataFile = open("metaInfo.json", "w+")
        lexiconedFile = open("file1.json", "w+")
